...
function Softplayhire() {
    ...
    useEffect (() => {
        const fetchProducts = async () => {
            try {
              const querySnapshot = await getDocs(collection(db, 'softPlay'));
  ...
  return (
    <div className='main-container'>
        ...
        <div>
            <h1 className='content-headline heading-content'>Soft Play Hire</h1>
        </div>
        <div className='content-section container'>
            <br />
            <h5>When it comes to convenience, we've got you covered! 
                We offer <b>delivery and set up of our bouncy castles within one hour</b> before the start of your party. 
                This allows you to focus on other party preparations while we handle the installation.

                Don't worry about the hassle of returning the bouncy castle immediately after the party ends. 
                You have a generous <b>4 hours from the start time of your party before we come to pick it up.</b> 
                This gives you and your little ones ample time to bounce, play, and have a blast!
            </h5>
            <br />
            <h5>
            Delivery Option:<br />
